    ...
    <div className="absolute px-8 py-2 bg-gradient-to-b from-black z-10 w-screen flex flex-col md:flex-row justify-between">
      ...
      {user && (
        <div className="flex p-2 justify-center">
          {showGptSearch && (
            <select
              className="p-2 bg-gray-800 text-white m-2 rounded-lg hover:bg-gray-600"
          ...
          <button
            ...
            className="text-white py-1 mr-4 m-2 px-2 font-semibold bg-red-700 rounded-xl hover:bg-red-600"
          >
          ...
          <button
            ...
            className="font-bold text-white m-3 pl-3"
          >
